the problem for this model is that
the last layer for the discriminator
Sigmoid function has been built into the BCE loss functions
but I still use sigmoid for the last layer
